...
public class HomeController : Controller
{
    ...
    public HomeController(ILogger<HomeController> logger)
    {
        ...
        {
            new MovieViewModel { Id = 13, Name ="Your Name.", Rating = "8.4", ReleaseYear = 2016, Genre = "Drama", Trailer ="https://www.youtube.com/watch?v=xU47nhruN-Q", Image ="https://m.media-amazon.com/images/M/MV5BNGYyNmI3M2YtNzYzZS00OTViLTkxYjAtZDIyZmE1Y2U1ZmQ2XkEyXkFqcGdeQXVyMTA4NjE0NjEy._V1_.jpg", About ="Two teenagers share a profound, magical connection upon discovering they are swapping bodies. Things manage to become even more complicated when the boy and girl decide to meet in person."},
